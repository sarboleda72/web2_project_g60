...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar"
            style="background: linear-gradient(135deg, #ff3c3c 0%, #ff6f61 50%, #b71c1c 100%);">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" @if (!request()->routeIs('products.*')) class="collapse" @endif
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" id="qSearch" class="form-control bg-light border-0 small"
                                placeholder="Buscar por..." aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn" type="button"
                                    style="background-color: #ff3c3c; color: #fff;">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <span class="badge badge-danger badge-counter"
                                    style="background-color: #ff3c3c; color: #fff;">3+</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button"
                                ...
                                <!-- Counter - Messages -->
                                <span class="badge badge-danger badge-counter"
                                    style="background-color: #ff3c3c; color: #fff;">7</span>
                            </a>
                            <!-- Dropdown - Messages -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
